...
class Index(object):
    ...
    def mapping(self, mapping):
        ...
        :class:`~elasticsearch7_dsl.Mapping`) with this index.
    ...
    def document(self, document):
        """
        Associate a :class:`~elasticsearch7_dsl.Document` subclass with an index.
        This means that, when this index is created, it will contain the
    ...
    def search(self, using=None):
        """
        Return a :class:`~elasticsearch7_dsl.Search` object searching over the
    ...
    def updateByQuery(self, using=None):
        """
        Return a :class:`~elasticsearch7_dsl.UpdateByQuery` object searching over the index
